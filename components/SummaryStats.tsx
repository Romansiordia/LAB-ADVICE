...
const StatCard: React.FC<StatCardProps> = ({ title, value, icon, iconBgColor }) => (
    <div className="bg-white border-2 border-slate-200 p-3 rounded-xl flex items-center space-x-3 shadow-md hover:shadow-lg transition-shadow duration-300">
    ...
    if (!stats) {
        return (
             <div className="mb-6">
                ...
                <div className="bg-white border-2 border-slate-200 p-4 rounded-xl shadow-md text-center">
                    <p className="text-slate-500">No hay datos para calcular estadísticas.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="mb-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                ...
                <StatCard title="Desv. Estándar" value={stats.stdDev} icon={<StdDevIcon />} iconBgColor="bg-blue-50" />
