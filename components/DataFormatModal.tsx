            ...
            >
                ...
                <div className="mb-6 p-4 bg-ui-darkest rounded-md">
                    ...
                    <ul className="list-disc list-inside text-sm space-y-1">
                        <li>Las columnas <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">date</code> (o <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">Fecha</code>) y <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">material</code> (o <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">Materia Prima</code>) son <span className="font-bold">obligatorias</span>.</li>
                        ...
                        <li><span className="font-semibold text-ui-accent">Formatos de fecha aceptados:</span> Se admiten múltiples formatos: <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">DD/MM/AAAA</code>, <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">MM/DD/AAAA</code>, <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">AAAA-MM-DD</code>, nombres de mes (ej. <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">1-ago-2026</code> o <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">1 de agosto de 2026</code>), años de 2 dígitos (<code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">8/1/26</code>), fechas con hora, y números de serie de Excel (<code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">46235</code>).</li>
                        <li>Las cabeceras aceptan acentos, mayúsculas, minúsculas y sufijos (ej. <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">Proteína (%)</code>, <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">Almidón</code>, <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">Fósforo</code>).</li>
                        <li><span className="font-semibold text-emerald-400">Recomendación:</span> Puedes cargar directamente tu archivo en formato <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">.xlsx</code> o <code className="bg-slate-200 text-slate-100 p-1 rounded text-xs">.xls</code>. Excel mantiene la posición fija de cada columna y previene desfasamientos causados por comas vacías en archivos CSV.</li>
