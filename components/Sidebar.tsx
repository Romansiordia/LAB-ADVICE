            ...
            {hasData && (
                 <div className="flex flex-col space-y-4">
                    <FilterSelect 
                        ...
                        options={materials}
                    />
                    {/* FIX: The FilterSelect component was incorrectly used with children. 
                        It has been replaced with a div and a custom select element to handle the nutrient options, 
                        which require different values and labels. */}
                    <div>
