...
export const FileUpload: React.FC<FileUploadProps> = ({ onFileParse, isLoading }) => {
    ...
    return (
        <div 
            ...
            className={`flex justify-center items-center w-full relative ${dragging ? 'border-cyan-400' : 'border-gray-300'}`}>
            <label htmlFor="file-upload" className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    {isLoading ? (
                        ...
                        <>
                            <UploadIcon />
                            <p className="mb-2 text-sm text-gray-500"><span className="font-semibold text-cyan-600">Click para subir</span> o arrastra</p>
                            <p className="text-xs text-gray-400">XLS, XLSX o CSV</p>
                        </>
                    )}
                </div>
